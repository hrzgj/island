...
public class StampServiceImpl extends ServiceImpl<StampMapper, Stamp> implements StampService {
    ...
    @Override
    public Page<Stamp> listStampsByPage(int page, int pageSize, String keyword) {
        log.info("正在执行分页查询stamp: page = {} pageSize = {} keyword = {}",page,pageSize,keyword);
        QueryWrapper<Stamp> queryWrapper =  new QueryWrapper<Stamp>().like("", keyword);
