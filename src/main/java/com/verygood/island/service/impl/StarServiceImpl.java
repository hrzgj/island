...
public class StarServiceImpl extends ServiceImpl<StarMapper, Star> implements StarService {
    ...
    @Override
    public Page<Star> listStarsByPage(int page, int pageSize, String keyword) {
        log.info("正在执行分页查询star: page = {} pageSize = {} keyword = {}",page,pageSize,keyword);
        QueryWrapper<Star> queryWrapper =  new QueryWrapper<Star>().like("", keyword);
